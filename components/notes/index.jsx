...
const Index = () => {
  ...
  return (
    ...
    <div className='bg-[#212529]/75 rounded-lg flex flex-col h-full p-4'>
      ...
      <textarea value={note} onChange={(e)=>setNote(e.target.value)} className='select-text 2xl:text-[1.3rem] bg-[#212529] h-full p-4 overflow-y-scroll rounded-lg focus:outline-none text-white/50  w-full flex-grow'/>
    </div>
    </Fade>
  )
}
